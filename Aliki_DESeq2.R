...
files = list.files("C:/Users/s2071467/Downloads/AlikiP/Count_files/")
x = readDGE(paste0("C:/Users/s2071467/Downloads/AlikiP/Count_files/", files), 
            columns = c(1,2))

# Rename samples with more readable names
sample_names_prev = colnames(x)
samplenames_almost = substring(colnames(x), 48, nchar(colnames(x)) - 7)
...
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots")
...
ggsave(filename = "MEL_filtered_read_counts_density_curves.tiff",
       path = "C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots",
...
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/meanSdPlot.tiff", res = 300, width = 4500, height = 1600, compression = "lzw")
fig
...
# log2(counts + 1)
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/top50_heatmap_log2(counts+1).tiff",
     res = 200, width = 1420, 
...
# rlog
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/top50_heatmap_rlog.tiff",
     res = 200, width = 1420, 
     height = 1080, compression = "lzw")
...
# vst
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/top50_heatmap_vst.tiff", res = 200, width = 1420, 
     height = 1080, compression = "lzw")
...
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/sample_distance_heatmap_vst.tiff", 
     res = 700, width = 6760, 
...
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/sample_poisson_distance_heatmap.tiff", res = 700, width = 6760, 
     height = 4760, compression = "lzw")
...
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/PCA.tiff", width = 2880, height = 1380, res = 700,
     compression = "lzw")
...
fig = ggarrange(mdsplot +rremove("ylab"), poisson_mdsplot +rremove("ylab"), 
                ...
                align = "hv",
                font.label = list(size =4, color = "black", face = "bold"))
tiff("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/MEL_plots/MDS.tiff", res = 700, width = 2880, height = 1080, compression = "lzw")
fig
...
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA")
saveWorkbook(dgea_wb, "C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/DGEA.xlsx",
             overwrite = TRUE)
saveWorkbook(dgea_wb_shrunk, "C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/DGEA_ashr.xlsx",
             overwrite = TRUE)
rm(genes, res, res_ashr, i); gc()

# MA-plots
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/MA_plots")
for (i in 1:length(results)) {
  tiff(paste0("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/MA_plots/MA_plot_",
...
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Volcano_plots")
...
for (i in 1:length(results)) {
  ...
  ggsave(filename = paste0("Volcano_raw_LFCs_", names(results)[i], ".tiff"),
         path = "C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Volcano_plots", 
...
library(genefilter)
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps")
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps/raw_lfcs")
dir.create("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps/ashr_shrunk")
...
tiff(paste0("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps/VST_top20vargenes_samples_heatmap.tiff"),
     res = 700, width = 6760, 
     height = 4760, compression = "lzw")
...
for (i in 1:length(results)) {
  ...
  tiff(paste0("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps/raw_lfcs/",
...
for (i in 1:length(ashr_shrunk_results)) {
  ...
  # In the plot below the cluster distances are not affected by the log-transformation
  # of the matrix. It is only used to make a smoother color scale
  tiff(paste0("C:/Users/s2071467/Desktop/Non_repo_projects/Aliki/DGEA/Post_DGEA_heatmaps/ashr_shrunk/",
